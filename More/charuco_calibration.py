...
# videoWriter = cv2.VideoWriter("./calib_cam/calib2.avi", fourcc, 30.0, (640,480))
...
saveCoefficients(mtx, dist, "calibrationCoefficients_plex.yaml")
mtx1, dist1 = loadCoefficients("calibrationCoefficients_plex.yaml")
